...
public final class Constants {
  ...
  public final class SwerveConstants {
    ...
    //Rotor Encode 偏移量    
    public static final double kLeftFrontRotorEncoderOffset = -41.9238 - 0.1757 + 0.6152 + 6.4  + 0.6 - 0.08 - 0.26 + 0.43  +3.867 -4.3;
    ...
    public static final double kRightRearRotorEncoderOffset = -40.166 + 0.966 + 2.2 - 4.5 + 0.6 - 0.36 + 3.16 -2.37 - 0.26 + 0.43;
